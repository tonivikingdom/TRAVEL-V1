...
- GitHub CI PostgreSQL 17、migration deploy、build 与 Compose 回归：等待功能分支推送后执行。

## 停止点

O-03 与 O-07 仍未解决。P2A 不支持跨午夜/跨时区高级 Day 投影、自动生命周期、Transport、
时间传播、跨日移动、Trip merge/copy/share、Undo、Provider 或正式 UI；P2B 尚未实现。
